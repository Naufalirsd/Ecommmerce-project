        ...
        <div class="flex flex-wrap mb-24 -mx-3">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                ...
                <div>
                    ...
                    <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="100000000" value="15000000" step="1000">
                    <div class="flex justify-between">
                        <span class="inline-block text-sm font-bold text-blue-400 truncate">
                            {{ Number::currency(1000, 'IDR') }}
                        </span>
                        <span class="inline-block text-sm font-bold text-blue-400 truncate text-right">
                            {{ Number::currency(100000000, 'IDR') }}
                        </span>
                    </div>
                </div>
            </div>
