          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent='save'>
              ...
              @if (session()->has('error'))
                <div class="mt-4 bg-red-100 border border-red-300 text-sm text-red-800 rounded-lg p-4 dark:bg-red-900/30 dark:border-red-700 dark:text-red-400" role="alert">
                  {{ session('error') }}
                </div>
              @endif
