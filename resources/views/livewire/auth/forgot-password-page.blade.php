          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent='save'>
              ...
              @if (session()->has('success'))
                <div class="mt-4 bg-green-100 border border-green-300 text-sm text-green-800 rounded-lg p-4 dark:bg-green-900/30 dark:border-green-700 dark:text-green-400" role="alert">
                  {{ session('success') }}
                </div>
              @endif
